(function() {
  ...
  function main() {
    ...
    var cubeVertices = [
      // x, y, z      r, g, b
      -0.5, 0.5,  0.5,   1.0, 1.0, 1.0, //BAD BDC 
      ...
      0.5,  0.5,  0.5,   0.0, 1.0, 0.0, //CDH CHG 
      ...
      0.5, -0.5,  0.5,   0.0, 0.0, 1.0, //DAE DEH 
      ...
      -0.5, -0.5, -0.5,   1.0, 1.0, 0.0, //EFG EGH
      ...
      -0.5, 0.5,  -0.5,   0.0, 1.0, 1.0, //FEA FAB
      ...
      -0.5, 0.5,  0.5,   0.0, 1.0, 1.0,
       ...
       0.5,  0.5, -0.5,  1.0, 0.0, 1.0, //GFB GBC
    ...
    var triangleVertices = new Float32Array([
            ...
            +0.05, +0.4,    1.0, 0.0, 0.0,
            +0.35, +0.4,    1.0, 0.0, 0.0,
            +0.35, +0.5,    1.0, 0.0, 0.0,
  
  
            +0.05, 0.0,     1.0, 1.0, 1.0,
            +0.05, +0.1,    1.0, 1.0, 1.0,
            +0.35, +0.1,    1.0, 1.0, 1.0,

            +0.05, +0.0,    1.0, 1.0, 1.0,
            +0.35, +0.0,    1.0, 1.0, 1.0,
            +0.35, 0.1,     1.0, 1.0, 1.0,
    ]);
